            ...
            <form onSubmit={onLogin}>
              <div className="pr-5 pt-7">
                <div dir="rtl">
                  <input
                    type="text"
                    className="w-[400px] mb-8  focus:outline-none border-4 border-t-0 border-l-0 border-r-0 login border-b-fuchsia-500"
                ...
                <div dir="rtl">
                  <input
                    type="password"
                    className="w-[400px] border-4 focus:outline-none border-t-0 border-l-0 border-r-0 login border-b-fuchsia-500 "
              ...
              <div className="mt-16 mr-24">
                <button className="w-[72%] py-2  text-purple-700 border-2 border-purple-700 ">
                  {translate.login}
                </button>
              </div>
            </form>
