...
import { welcomeUN as translate } from "../public/locales/fa.json";
    ...
    <>
      ...
      <div className="sticky my-20 overflow-hidden bg-white md:w-4/5 md:mx-auto rounded-2xl ">
        <section className="flex flex-col-reverse items-center justify-between shadow-xl md:flex-row md:items-center">
          ...
          <div className="w-[50%] md:w-[60%] pb-32 p:pb-0 md:mt-8 ">
              ...
              <div className="pr-5 mt-7">
                ...
                <div className="relative my-6">
                  <div dir="rtl" className="flex ">
                    <select className="w-full mx-auto md:w-[70%] focus:text-base appearance-none  text-xs  border-[3px] border-t-0 border-l-0 border-r-0 focus:outline-none login border-b-fuchsia-500  ">
                    ...
                    <ChevronDownIcon className="absolute top-0 h-6 w-7 left-36 text-fuchsia-500" />
                  </div>
                </div>
            ...
            <div dir="rtl" className="mt-1 text-center md:mx-auto w-96">
